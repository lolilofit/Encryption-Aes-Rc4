...
2. Алгоритм блочного шифрования Aes, длина блока 16 байт, 10 раундов шифрования. 
...
3. Хэширование на основе Aes. Пользователь вводит начальный ключ длины 10, блоки шифруются, ключом служит зашифрованное сообщение с предыдущего шага. 